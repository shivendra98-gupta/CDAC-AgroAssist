...
import './../../styles/adminStyles/AllProductsComponent.css'; // Ensure this CSS file is correctly set up
import { Link } from 'react-router-dom'; // For editing link
                    ...
                    <tbody>
                        {products.map((product) => (
                            <tr key={product.id}>
                                ...
                                <td>{product.productRating}/5</td>
                                <td>{product.categoryName || 'No category assigned'}</td>
                                <td>
