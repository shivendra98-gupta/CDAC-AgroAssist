...
// import './../../styles/adminStyles/EditProductComponent.css'; // Ensure this CSS file exists
...
const EditProductComponent = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategories = async () => {
            try {
                const response = await axios.get('http://localhost:8080/categories'); // Adjust if necessary
